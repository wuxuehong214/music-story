...
public class HexByteStringUtil
{
    ...
    /**
     * bytes字符串转换为Byte�?
     * @param src String Byte字符串，每个Byte之间没有分隔�?字符范围:0-9 A-F)
     * @return byte[]
     */
     ...
     * @param hex String 16进制值字符串 （一个unicode�?byte�?
     * @return String 全角字符�?
